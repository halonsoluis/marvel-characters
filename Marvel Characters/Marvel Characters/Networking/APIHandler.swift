...
struct APIHandler {
    ...
    func getSecurityFootprint(timestamp: String = NSDate.timeIntervalSinceReferenceDate().description, privateAPIKey : String = APIHandler.privateAPIKey, publicAPIKey: String = APIHandler.publicAPIKey) -> (timeStamp: String, hash: String, APIKey: String)? {
